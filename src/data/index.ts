...
export const QUESTIONS = { ...FOUNDATION_QUESTIONS, ...MODULE1_SAFETY_QUESTIONS, ...ELECTRO_QUESTIONS, ...MECHANICS_QUESTIONS, ...AUTOMATISME_QUESTIONS, ...MAINTENANCE_QUESTIONS };
