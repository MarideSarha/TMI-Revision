...
export const QUESTIONS = { ...FOUNDATION_QUESTIONS, ...MODULE1_SAFETY_QUESTIONS, ...MODULE1_PREPARATION_QUESTIONS, ...MODULE1_WORKSHOP_RISK_QUESTIONS, ...ELECTRO_QUESTIONS, ...MECHANICS_QUESTIONS, ...AUTOMATISME_QUESTIONS, ...MAINTENANCE_QUESTIONS };
